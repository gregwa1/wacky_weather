...
- Include data from a third-party API.
	...
	[Instructor Recommended APIs](https://git.generalassemb.ly/sei-nyc-dinosaurs/apis)
...
**Refer to the [project worksheet](https://git.generalassemb.ly/sei-nyc-dinosaurs/project-2-prompt/blob/master/project-worksheet.md) file in this repo for structuring your README.**
